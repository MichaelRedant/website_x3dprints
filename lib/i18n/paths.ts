...
const EN_BLOG_SLUGS = new Set<string>([
  ...
  "3d-print-offerte-aanvragen",
  "3d-print-ontwerp-checklist",
  "3d-print-ontwerp-gids",
  "3d-print-prijs-per-stuk",
  "3d-print-prijzen-gids",
  "hittebestendig-3d-print-materiaal",
  "ikea-onderdelen-3d-printen",
  "kabelmanagement-3d-printen",
  "kapot-onderdeel-laten-printen",
  "prototyping-kleine-reeksen-3d-printen",
  "retail-pos-3d-printen",
  "sterke-3d-print-materialen",
  "vervangstuk-huishoudtoestel-3d-printen",
])
