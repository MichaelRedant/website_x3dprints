// app/(pages)/materials/[slug]/material-detail.tsx
...
import { MATERIAL_DETAILS_BY_SLUG } from "@/content/material-details"
...
export async function renderMaterialDetail({ slug, locale }: LocalizedMaterialArgs) {
  const isEn = locale === "en"
