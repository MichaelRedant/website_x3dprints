...
const faq = BLOG_FAQ["filament-vrijdag-pc"]
...
const articleJsonLd = buildArticleJsonLd({
  ...
  description: "Polycarbonaat 3D printen uitgelegd door X3DPrints: droogtijd, instellingen, toepassingen en do's & don'ts.",
