...
export const NL_METADATA: Metadata = buildMetadata(COPY.nl.meta, NL_CANONICAL, "nl_BE")

type Locale = "nl" | "en"

export function renderOctopusCase(locale: Locale) {
  ...
  return (
    <article className="relative overflow-hidden px-4 pb-24 pt-12 sm:px-6 lg:px-8">
      ...
      <BlogContentOverview locale={locale} />
