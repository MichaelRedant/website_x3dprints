...
const articleJsonLd = {
  ...
  description:
    "How-to gids voor geprinte schroefdraad, zelftappende schroeven en heat set inserts in PLA, PETG en TPU. Inclusief toleranties en ontwerpregels.",
    ...
    <main className="relative">
        ...
        <div className="mx-auto grid max-w-5xl gap-6 lg:grid-cols-2">
          <Reveal>
            <GlassCard className="border border-white/40 bg-white/85 p-6 shadow-lg backdrop-blur">
              <h2 className="text-2xl font-semibold text-slate-900">1. Geprinte schroefdraad: wanneer wel, wanneer niet?</h2>
      ...
      <section className="px-6 pb-12 sm:px-8 lg:px-12">
        <div className="mx-auto grid max-w-5xl gap-6 lg:grid-cols-2">
          <Reveal>
            <GlassCard className="border border-white/40 bg-white/85 p-6 shadow-lg backdrop-blur">
              <h2 className="text-2xl font-semibold text-slate-900">4. Veelgemaakte fouten</h2>
          ...
          <Reveal delay={0.1}>
            <GlassCard className="border border-white/40 bg-white/85 p-6 shadow-lg backdrop-blur">
              <h2 className="text-2xl font-semibold text-slate-900">5. Checklist voor je CAD</h2>
              <ul className="mt-4 space-y-2 text-sm text-slate-600">
                {checklist.map((item) => (
                  <li key={item} className="rounded-2xl border border-slate-100 bg-white/70 p-3">
                    {item}
