...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: PAGE.seo.ogImage
      ...
      : [{ url: "/images/organizers/modugrid/ModuGrid10.webp", width: 1200, height: 900, alt: "Custom toolbox insert op maat" }],
    siteName: SITE.name,
    locale: SITE.locale,
  },
        ...
        <Reveal className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-2 rounded-2xl border border-slate-100 bg-white/70 p-4 text-sm text-slate-800 ring-1 ring-white/60 backdrop-blur dark:border-slate-800 dark:bg-[#0B0F1A]/70 dark:text-slate-100 dark:ring-0">
              <div className="text-xs font-semibold uppercase tracking-[0.2em] text-amber-700">Typische custom cases</div>
            ...
            <div className="flex flex-wrap gap-3 text-sm">
              <Link
                href={contactHref}
                className="inline-flex items-center gap-2 rounded-xl bg-slate-900 px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-slate-900/20 transition hover:-translate-y-0.5 hover:brightness-110 dark:bg-amber-500"
              >
                Start custom intake
              ...
              <a href="#custom-sources" className="underline decoration-amber-400 hover:decoration-amber-700">
                Bronnen
              </a>
            </div>
          </div>
