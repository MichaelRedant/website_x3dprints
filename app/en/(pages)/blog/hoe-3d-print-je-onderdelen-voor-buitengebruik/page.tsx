...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/images/og-home.jpg", width: 1200, height: 630, alt: "Outdoor 3D print advice by X3DPrints" }],
    locale: "en_BE",
    siteName: "X3DPrints",
  },
  twitter: {
...
const articleJsonLd = {
  ...
  description:
    "Practical guide for outdoor 3D print projects with PETG, TPU and hybrid constructions. Includes mounting tips and cost guidance.",
