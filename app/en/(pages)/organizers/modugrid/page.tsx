...
const CAROUSEL_ITEMS = [
  { src: "/images/organizers/modugrid/ModuGrid1.jpg", alt: "ModuGrid drawer overview (gridfinity alternative)", width: 1200, height: 900 },
  { src: "/images/organizers/modugrid/ModuGrid2.jpg", alt: "ModuGrid drawer with screws and bits, made-to-fit", width: 1200, height: 900 },
  { src: "/images/organizers/modugrid/ModuGrid3.webp", alt: "ModuGrid tray with bits and screws, label-ready", width: 1200, height: 900 },
  { src: "/images/organizers/modugrid/ModuGrid4.webp", alt: "ModuGrid bins for desk tools and EDC", width: 1200, height: 900 },
  { src: "/images/organizers/modugrid/ModuGrid5.webp", alt: "ModuGrid detail with labels and anti-slip", width: 1200, height: 900 },
  { src: "/images/organizers/modugrid/ModuGrid6.webp", alt: "ModuGrid insert with anti-slip, ready for transport", width: 1200, height: 900 },
  { src: "/images/organizers/modugrid/ModuGrid7.webp", alt: "ModuGrid drawer in use, fast access", width: 1200, height: 900 },
  { src: "/images/organizers/modugrid/ModuGrid8.webp", alt: "ModuGrid custom pocket for multimeter and probes", width: 1200, height: 900 },
  { src: "/images/organizers/modugrid/ModuGrid9.webp", alt: "ModuGrid baseplate with mixed bins (toolbox inlay)", width: 1200, height: 900 },
  { src: "/images/organizers/modugrid/ModuGrid10.webp", alt: "ModuGrid hobby setup for paint and minis", width: 1200, height: 900 },
  { src: "/images/organizers/modugrid/ModuGrid11.webp", alt: "ModuGrid drawer with tools and labels, gridfinity-compatible", width: 1200, height: 900 },
]
...
export const metadata: Metadata = {
  title: "ModuGrid (gridfinity-style) organizers | X3DPrints",
  description:
    "Gridfinity-compatible ModuGrid organizers for drawers, desks and cases. Prefab sets plus custom per-tool pockets, labelable and anti-slip. Toolbox inlay made in Belgium.",
  alternates: {
    canonical: PAGE_URL,
    languages: {
  ...
  openGraph: {
    title: "ModuGrid organizers | X3DPrints",
    description:
      "Gridfinity-style ModuGrid inserts with label zones and anti-slip. Custom pockets per tool, made in Belgium.",
    url: PAGE_URL,
...
const FAQ_EN = [
  ...
  },
  {
    ...
    a: "No. ModuGrid fits office drawers, maker desks, ESD benches, hobby paint/miniatures, sewing and craft kits, and education/STEM sets.",
  },
  {
    ...
    <>
      <div className="mx-auto max-w-6xl px-4 py-12 sm:py-16 lg:py-20">
        <Reveal className="space-y-6">
          <div className="inline-flex items-center gap-2 rounded-full bg-cyan-50 px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-cyan-800 ring-1 ring-cyan-100 dark:bg-[#0f162c] dark:text-cyan-200">
            ModuGrid · gridfinity-style without loose bins
          </div>
          <div className="space-y-4">
            <h1 className="text-balance text-4xl font-extrabold text-slate-900 sm:text-5xl">
              Custom ModuGrid organizers for your system.
            </h1>
      ...
      <section className="bg-gradient-to-b from-white to-slate-50 px-4 py-12 sm:py-16 dark:from-[#050815] dark:to-[#0B0F1A]">
        <div className="mx-auto max-w-6xl space-y-10">
          <section id="bundles">
            <Reveal>
              <OrganizerBundles systemSlug={PAGE.slug} systemName="ModuGrid (gridfinity-style)" bundles={BUNDLES_EN} />
            </Reveal>
          </section>
      ...
      <div className="mx-auto max-w-5xl px-4 py-12 sm:py-16">
        <section id="faq">
        <Reveal className="rounded-3xl border border-slate-100 bg-white/80 p-6 ring-1 ring-white/70 backdrop-blur dark:border-slate-800 dark:bg-[#0B0F1A]/80 dark:ring-0">
          <Faq items={FAQ_EN} title="Frequently asked questions about ModuGrid organizers" className="mt-0" />
        </Reveal>
        </section>
      </div>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify([
            ...
            ...imageObjects,
            {
              "@context": "https://schema.org",
              "@type": "HowTo",
              name: "Request a custom ModuGrid pocket",
              ...
              step: [
                ...
                { "@type": "HowToStep", position: 5, name: "Send", text: "Upload via the contact form (prefill ModuGrid)." },
              ],
