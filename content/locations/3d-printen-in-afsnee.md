...
|-------------|--------------------------|-----------------------|
| **PLA Matte** | Stijf, detailrijk         | Maquettes langs de Leie via **3D printen in Afsnee** |
| **PETG**     | Taai, temperatuurbestendig | Functionele onderdelen met **3D printen in Afsnee** |
| **TPU**      | Flexibel, buigzaam        | Beschermhoezen en grips door **3D printen in Afsnee** |
...
Educatieve modellen en decorstukken voor evenementen ontstaan via **3D printen in Afsnee**.

---

## Rapid prototyping in Afsnee
Met **rapid prototyping** via **3D printen in Afsnee** doorloop je sneller de ontwikkelingscyclus. Test vorm en pasvorm binnen enkele dagen zonder hoge kosten.

---

## Afsnee en de link met Gent

- [Stad Gent](https://stad.gent) stimuleert innovatie en lokale productie.
- De nabijheid van de Leie en de Sint-Jan-de-Doperkerk geeft **3D printen in Afsnee** een unieke setting.
...
**Hoe snel is 3D printen in Afsnee?**
