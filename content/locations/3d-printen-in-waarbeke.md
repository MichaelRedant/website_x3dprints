...
<!-- LOCAL_ENRICH_START -->
## Wat je moet weten in Waarbeke

- Dekking: Waarbeke; levering vanuit Herzele, afhalen kan.
- Typische opdrachten: prototypes, behuizingen en beugels voor teams in Waarbeke.
...
## Landmarks in de buurt van Waarbeke
- Centrum van Waarbeke
- Lokale bedrijvenzone in Waarbeke
- Sporthal in Waarbeke

## Teams die we ondersteunen rond Waarbeke
- KMO's en makers in Waarbeke: pasmallen en behuizingen.
- Retail/events rond Waarbeke: displays en props.
- Onderwijs/labs in Waarbeke: lesklare prints.

## Wat vaak wordt gevraagd in Waarbeke
