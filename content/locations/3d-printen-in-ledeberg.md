...
|-------------|--------------------------|-----------------------|
| **PLA Matte** | Stijf, detailrijk         | Maquettes van het Ledebergplein via **3D printen in Ledeberg** |
| **PETG**     | Taai, temperatuurbestendig | Functionele onderdelen met **3D printen in Ledeberg** |
| **TPU**      | Flexibel, buigzaam        | Beschermhoezen en grips door **3D printen in Ledeberg** |
...
Educatieve modellen en decorstukken voor evenementen ontstaan via **3D printen in Ledeberg**.

---

## Rapid prototyping in Ledeberg
Met **rapid prototyping** via **3D printen in Ledeberg** doorloop je sneller de ontwikkelingscyclus. Test vorm en pasvorm binnen enkele dagen zonder hoge kosten.

---

## Ledeberg en de link met Gent

- [Stad Gent](https://stad.gent) stimuleert innovatie en lokale productie.
- Het Ledebergplein en de Sint-Amanduskerk geven **3D printen in Ledeberg** een stedelijke toets.
...
## Veelgestelde vragen over 3D printen in Ledeberg
