...
const IMAGES: CarouselImage[] = [
  { src: "/images/organizers/modugrid/ModuGrid1.jpg", alt: "ModuGrid lade overzicht" },
  { src: "/images/organizers/modugrid/ModuGrid2.jpg", alt: "ModuGrid lade met schroeven en bits" },
  { src: "/images/organizers/modugrid/ModuGrid3.webp", alt: "ModuGrid lade met bits en schroeven" },
  { src: "/images/organizers/modugrid/ModuGrid4.webp", alt: "ModuGrid bakjes voor bureau tools" },
  { src: "/images/organizers/modugrid/ModuGrid5.webp", alt: "ModuGrid detail met labels" },
  { src: "/images/organizers/modugrid/ModuGrid6.webp", alt: "ModuGrid insert met antislip" },
  { src: "/images/organizers/modugrid/ModuGrid7.webp", alt: "ModuGrid lade tijdens gebruik" },
  { src: "/images/organizers/modugrid/ModuGrid8.webp", alt: "ModuGrid custom vak voor multimeter" },
  { src: "/images/organizers/modugrid/ModuGrid9.webp", alt: "ModuGrid baseplate met gemengde bakjes" },
  { src: "/images/organizers/modugrid/ModuGrid10.webp", alt: "ModuGrid hobby setup voor verf en miniaturen" },
  { src: "/images/organizers/modugrid/ModuGrid11.webp", alt: "ModuGrid lade met tools en labels" },
]
...
export default function ModuGridCarousel() {
  ...
  return (
    <div className="space-y-3">
      <h2 className="text-xl font-bold text-slate-900 dark:text-white">ModuGrid in beeld</h2>
